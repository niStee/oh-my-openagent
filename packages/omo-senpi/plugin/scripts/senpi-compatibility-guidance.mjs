...
| final-review / gate-reviewer \`task(...)\` | fresh \`task\` with \`subagent_type: "omo-senpi-gate-reviewer"\` (the builtin gate reviewer, category-routed \`deep\` then \`unspecified-high\`) and the review inputs; \`plan-reviewer\`/\`plan-consultant\` are plan-gated curated reviewers, spawnable only while the plan gate is open |
