...
const passingInput = {
	...
	parentOutput:
		'Target "nonexistent" not found. Available agents: explore, librarian, omo-senpi-code-reviewer, omo-senpi-gate-reviewer, omo-senpi-qa-executor, plan-consultant, plan-reviewer. Available categories: mockcat.',
};
