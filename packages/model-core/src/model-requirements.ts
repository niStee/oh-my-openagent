...
export const AGENT_MODEL_REQUIREMENTS: Record<string, ModelRequirement> = {
  sisyphus: {
    fallbackChain: [
      {
        providers: ["github-copilot", "anthropic", "opencode", "vercel"],
  ...
  hephaestus: {
    ...
    requiresProvider: ["openai", "venice", "opencode", "vercel"],
  },
  oracle: {
    fallbackChain: [
      {
  ...
  librarian: {
    fallbackChain: [
      ...
      { providers: ["github-copilot", "anthropic", "opencode", "vercel"], model: "claude-haiku-4-5" },
  ...
  atlas: {
    fallbackChain: [
      { providers: ["github-copilot", "anthropic", "opencode", "vercel"], model: "claude-sonnet-4-6" },
      { providers: ["opencode-go", "vercel"], model: "kimi-k2.6" },
      {
        providers: ["openai", "opencode", "vercel"],
        model: "gpt-5.5",
...
export const CATEGORY_MODEL_REQUIREMENTS: Record<string, ModelRequirement> = {
  ...
  artistry: {
    fallbackChain: [
      ...
      { providers: ["openai", "opencode", "vercel"], model: "gpt-5.5" },
      { providers: ["opencode-go", "vercel"], model: "kimi-k2.6" },
      { providers: ["opencode-go", "vercel"], model: "glm-5.1" },
    ],
  },
