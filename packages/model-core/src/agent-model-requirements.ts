...
export const AGENT_MODEL_REQUIREMENTS: Record<string, ModelRequirement> = {
  ...
  hephaestus: {
    ...
    requiresProvider: [SUPPORTED_PROVIDERS.OPENAI, SUPPORTED_PROVIDERS.GITHUB_COPILOT, SUPPORTED_PROVIDERS.VENICE, SUPPORTED_PROVIDERS.OPENCODE, SUPPORTED_PROVIDERS.VERCEL],
    requiresAnyModel: true,
  },
  oracle: {
    fallbackChain: [
